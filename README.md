...
3D maps of the indoor & outdoor culvert generated by RTAB-Map with crack and spall labels and ER condition map (bottom 2) outputted by manual and and our proposed method. The condition metric ER unit is Ωm, where 120 < ER means good, 80 < ER < 120 means fair, and ER < 80 means poor. While manual inspection does have more information about the condition of the culvert, the extra info is \textbf{not relevant} since inspectors are only concern with the poor regions.
